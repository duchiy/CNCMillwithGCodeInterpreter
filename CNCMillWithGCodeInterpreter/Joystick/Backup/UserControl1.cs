...
namespace MoyStick
{
	...
	public class UserControl1 : System.Windows.Forms.Control
	{
        ...
        public event MouseStickMovedEventHandler MouseStickMovedZ;
		...
		private void InitializeComponent()
		{
            ...
            this.MouseMoveZ += new System.Windows.Forms.MouseEventHandler(this.UserControl1_MouseMoveZ);
        ...
        private void UserControl1_MouseMoveZ(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            if (isActive)
            {
                if (e.Button == MouseButton.Left)
                    this.ZDirectionUp = false;
                else
                    this.ZDirectionUp = true;

            }

            if (MouseStickMovedZ != null)
                MouseStickMovedZ(this, new MouseStickEventArgs(this.ZDirection));
