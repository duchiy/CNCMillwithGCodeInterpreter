...
namespace motionTestCLR
{
    public struct PathStruct
    {
        ...
        public double Xorigin, Yorigin, Zorigin;
    ...
    public class PathSettings
    {
        ...
        public PathStruct GetSetting()
        {

            PathStruct mypathStruct = new PathStruct();
            mypathStruct.Frequency = _Frequency;
            mypathStruct.NumberOfPts = 75;
            mypathStruct.Xscale = 15000.0; mypathStruct.Yscale = 15000.0; mypathStruct.Zscale = 15000.0;
            mypathStruct.Acceleration = 0.175;
            mypathStruct.Feedrate = 0.175;
            mypathStruct.Tolerance = 10.0;
            mypathStruct.Xorigin = 0.0; mypathStruct.Yorigin = 0.0; mypathStruct.Zorigin = 0.0;
