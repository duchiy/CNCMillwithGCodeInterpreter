...
namespace XGamePad
{
    ...
    public class Gamepad
    {
        ...
        private GamepadButtons _lastDPadState = 0;
        private byte lastLeftTrigger = 0;
        private byte lastRightTrigger = 0;
        private bool leftTriggerPressed = false;
        private bool rightTriggerPressed = false;
        private double _rightThumbRadius;
        private double _rightThumbX;
        private double _rightThumbY;
        private double _leftThumbRadius;
        private double _leftThumbX;
        private double _leftThumbY;
        bool _LeftThumbMoving = false;
        bool _RightThumbMoving = false;

        public bool _ZdirectionDown = false;
        public bool _Move3Axis = false;
        /**
         * Event handlers
         **/
        ...
        public event ThumbHandler OnThumbBackInsideRadius;
        ...
        public double CalculatePosDifference(double previous, double current, double tolerance)
        {

            double posdifference = current - previous;

            if (Math.Abs(posdifference) <= tolerance)
            {
                posdifference = 0.0;
            }
        ...
        public double CalculatePosDifference(double previous, double current)
        {
